...
//         it('Setting and Getting', function () {
...
//         it('Setting & getting - no more added than neccesary', function () {
//             assert.equal(
//                 Array.from(new SVGNode('a').set('x', 123).attributes).length,
//                 1,
//             )
//             assert.equal(
//                 Array.from(
...
//         it('Setting & getting multiple attributes', function () {
...
//         it('Setting & getting - Other properties are not affected', function () {
...
//                 new SVGNode('path')
//                     .set('d', new SVGPathData().moveTo(10, 10))
//                     .map('d', (val: SVGPathData) => val.lineTo(20, 20))
//                     .get('d'),
//                 'M 10 10 L 20 20',
//             )
//         })
...
//             assert.isTrue(new SVGNode('a').append(el1).children[0].equals(el1))
//             assert.isTrue(
...
//             assert.isTrue(new SVGNode('a').append(el2).children[0].equals(el2))
//             assert.isTrue(
...
//             assert.isFalse(new SVGNode('a').append(el2).children[0].equals(el1))
//             assert.isFalse(
...
//             )
//             assert.equal(
//                 new SVGNode('a').append(el1).append(el2).append(el3).children
//                     .length,
//                 3,
//             )
...
//         it('Appending - Other properties are not affected', function () {
//             assert.equal(
//                 new SVGNode('a').append(svgCircle(5)).attributes.entries.length,
//                 0,
//             )
//             assert.equal(new SVGNode('a').append(svgCircle(5)).tags.length, 0)
//             assert.equal(new SVGNode('a').append(svgCircle(5)).events.length, 0)
//             assert.equal(new SVGNode('a').append(svgCircle(5)).tagName, 'a')
//             assert.equal(new SVGNode('a').append(svgCircle(5)).innerText, '')
//         })
...
//             assert.equal(new SVGNode('a').append(el1).children.length, 1)
//             assert.equal(new SVGNode('path').append(el1).children.length, 1)

//             assert.equal(
//                 new SVGNode('a').append(el1).removeChildren().children.length,
//                 0,
//             )
//             assert.equal(
//                 new SVGNode('path').append(el1).removeChildren().children
//                     .length,
//                 0,
//             )
//         })
...
//             assert.equal(
//                 new SVGNode('a').append(el1).removeChild(0).children.length,
//                 0,
//             )
//             assert.equal(
//                 new SVGNode('path').append(el1).removeChild(0).children
//                     .length,
//                 0,
//             )

//             expect(new SVGNode('a').append(el1).removeChild(1)).to.throw
//             expect(new SVGNode('path').append(el1).removeChild(1)).to.throw
//         })
//     })
...
//             assert.isTrue(
//                 new SVGNode('a').text('x').equals(new SVGNode('a').text('x')),
//             )

//             assert.isFalse(
//                 new SVGNode('a').text('xyz').equals(new SVGNode('a').text('x')),
//             )
...
//             assert.isFalse(
//                 new SVGNode('a').tag('xyz').equals(new SVGNode('a').tag('x')),
//             )
...
//             assert.isFalse(new SVGNode('a').shallowEquals(new SVGNode('path')))
...
//         assert.equal(svgCircle(0).on('click', f).events[0].eventName, 'click')
...
//         )
//         assert.equal(
//             svgCircle(0).on('click', f).on('mouseover', g).events[0].eventName,
//             'click',
//         )
//         assert.equal(
...
//         )
//         assert.equal(
//             svgCircle(0).on('click', f).on('mouseover', g).events[1].eventName,
//             'mouseover',
//         )
//         assert.equal(
...
//         assert.isTrue(svgCircle(0).animate(animate).children[0].equals(animate))
//     })
...
//     it('x', function () {
//         assert.isTrue(svgCircle(1).x(543).equals(svgCircle(1).set('x', 543)))
//         assert.isFalse(svgCircle(1).x(543).equals(svgCircle(1).set('x', 456)))
//     })

//     it('y', function () {
//         assert.isTrue(svgCircle(1).y(543).equals(svgCircle(1).set('y', 543)))
//         assert.isFalse(svgCircle(1).y(543).equals(svgCircle(1).set('y', 456)))
//     })

//     it('cx', function () {
//         assert.isTrue(svgCircle(1).cx(543).equals(svgCircle(1).set('cx', 543)))
//         assert.isFalse(svgCircle(1).cx(543).equals(svgCircle(1).set('cx', 456)))
//     })

//     it('cy', function () {
//         assert.isTrue(svgCircle(1).cy(543).equals(svgCircle(1).set('cy', 543)))
//         assert.isFalse(svgCircle(1).cy(543).equals(svgCircle(1).set('cy', 456)))
//     })

//     it('r', function () {
//         assert.isTrue(svgCircle(1).r(543).equals(svgCircle(1).set('r', 543)))
//         assert.isFalse(svgCircle(1).r(543).equals(svgCircle(1).set('r', 456)))
//     })
...
//             svgCircle(1)
//                 .fill(543, 123)
//                 .equals(svgCircle(1).set('fill', 543).set('fill-opacity', 123)),
//         )
//         assert.isFalse(
//             svgCircle(1)
//                 .fill(543, 123)
//                 .equals(svgCircle(1).set('fill', 543).set('fill-opacity', 321)),
//         )
//     })

//     it('stroke', function () {
//         assert.isTrue(
//             svgCircle(1).stroke(543).equals(svgCircle(1).set('stroke', 543)),
//         )
//         assert.isFalse(
//             svgCircle(1).stroke(543).equals(svgCircle(1).set('stroke', 456)),
//         )
...
//                 .stroke(543, 123)
//                 .equals(
//                     svgCircle(1).set('stroke', 543).set('stroke-width', 123),
//                 ),
//         )
//         assert.isFalse(
//             svgCircle(1)
//                 .stroke(543, 123)
//                 .equals(
//                     svgCircle(1).set('stroke', 543).set('stroke-width', 321),
//                 ),
//         )
...
//                     .events.every(
//                         (event, index) =>
//                             el2.events[index].eventName === event.eventName &&
...
//         assert.notEqual(el1.toHash(), el1.copy().append(svgCircle(2)).toHash())
//         assert.notEqual(el1.toHash(), el1.copy().tag('tag1').toHash())
//         assert.notEqual(new SVGNode('a').toHash(), new SVGNode('path').toHash())
//     })

//     it('toHTML', function () {
//         const el1 = svgCircle(5)
//         assert.isTrue(
//             el1.equals(svgXMLtoNode((el1.toHTML() as unknown) as HTMLElement)),
//         )
//         assert.isFalse(
//             el1.equals(
//                 svgXMLtoNode(
